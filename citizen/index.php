          ...
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                    $query="SELECT * from `citizen` where Citizen_id='$_SESSION[citizen]'";
                        ...
                        <div class="card-body text-center">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm  text-left">
                              <h4><strong>DOB</strong> : <?php echo $record[3];?></h4>
                            </div>
                          </div>
                          <br />
                          <div class="row">
                            <div class="col-sm-3  text-left">
                              <h4><strong>S/o</strong> : <?php echo $record[4];?></h4>
                            </div>
                            <div class="col-sm-4  text-left">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-5  text-left">
                              <h4><strong>Police Station</strong> : <?php echo $record[8];?></h4>
                            </div>
                          </div>
                        </div>
                      </div>
