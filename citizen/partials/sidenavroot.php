  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="permissions">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/cases/firs.php">View FIR</a>
          </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="documents">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" href="./pages/permit/apply.php">Apply for Arms</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/permit/view.php">Application Status</a>
          </li>
        </ul>
      </div>
    </li>
